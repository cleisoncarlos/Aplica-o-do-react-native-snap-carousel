  ...
  const [lista, setLista] = useState([
    {
      ...
      text:
        'Cthulhu é um deus que nas primeiras páginas do conto aparece como um ídolo de argila quase indescritível possuindo um culto multimilenar dedicado a trazê-lo de volta , um retorno que desencadearia o fim da Humanidade o conto foi escrito em fevereiro de 1928',
      release: 2018,
      img: 'https://m.media-amazon.com/images/I/51VIb7Rbo5L.jpg',
    },

    {
      ...
      text:
        'Cthulhu é um deus que nas primeiras páginas do conto aparece como um ídolo de argila quase indescritível possuindo um culto multimilenar dedicado a trazê-lo de volta , um retorno que desencadearia o fim da Humanidade o conto foi escrito em fevereiro de 1928',
      release: 2018,
      img: 'https://m.media-amazon.com/images/I/51sMPX-nKzL.jpg',
    },

    {
      title: 'A cor que caiu do céu',
      text:
        'Cthulhu é um deus que nas primeiras páginas do conto aparece como um ídolo de argila quase indescritível possuindo um culto multimilenar dedicado a trazê-lo de volta , um retorno que desencadearia o fim da Humanidade o conto foi escrito em fevereiro de 1928',
      release: 2018,
      img: 'https://m.media-amazon.com/images/I/51nBsyMgB-L.jpg',
    },

    {
      ...
      release: 2018,
      img: 'https://images-na.ssl-images-amazon.com/images/I/91Gq0qYTNDL.jpg',
    },

    {
      ...
      release: 2018,
      img:
        'https://cdn.shopify.com/s/files/1/0747/3829/products/mL3982_1024x1024.jpg',
    },

    {
      title: 'Os Últimos Jedi',
      text:
        'Após o assassinato de sua família, Frank Castle está traumatizado e sendo caçado. No submundo do crime, ele se tornará aquele conhecido como O Justiceiro',
      release: 2018,
      img:
        'https://images-na.ssl-images-amazon.com/images/M/MV5BMjQ1MzcxNjg4N15BMl5BanBnXkFtZTgwNzgwMjY4MzI@._V1_.jpg',
    },
